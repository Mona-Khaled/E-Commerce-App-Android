...
public class ProductAdabter extends ArrayAdapter {
  ...
  private LinkedHashSet<Integer> selected_items=new LinkedHashSet<>();
    ...
    ////////////////////////////// custom adapter badelo el layout bta3y
    @NonNull
    @Override
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView==null)
            ...
            product_price.setText(data.get(position).getPrice() + " LE");
...
/////////////////////////////////////////////////////////// ADD TO CART BUTTON //////////////////////////////////////////////
        ...
        notifyDataSetChanged();  //to change in adapter directly
...
////////////////////// to not add product more than once to cart /////////////////////////////////////////
